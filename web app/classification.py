...
for paper in India:
    ...
    IndiaPapers[paper[0]] = cleanedText
...
for paper in Brazil:
    full_text = ' '.join(paper[1])
    cleanedText = TM.toSentences(full_text, 'english', language_keywords['english'])
    BrazilPapers[paper[0]] = cleanedText
...
for paper in Mexico:
    full_text = ' '.join(paper[1])
    cleanedText = TM.toSentences(full_text, 'spanish', language_keywords['spanish'])
    MexicoPapers[paper[0]] = cleanedText
